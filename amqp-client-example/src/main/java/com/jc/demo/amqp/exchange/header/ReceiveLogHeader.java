package com.jc.demo.amqp.exchange.header;
...
public class ReceiveLogHeader {
	...
	public static void main(String[] argv) throws Exception {
		...
		// information
		// from the sender here as the routing key is still available in the
		// received message.
		String routingKeyFromUser = "ourTestRoutingKey";

		// Argument processing: the first arg is the local queue name, the rest
		// are
		// key value pairs for headers.
		String queueInputName = "com.jc.queue.header";
		...
		// Note that when you run this code you should include the x-match
